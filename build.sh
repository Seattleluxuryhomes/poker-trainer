...
build_one() {
  ...
  cat "$ROOT/src/engine.js" "$ROOT/src/holdem.js" "$ROOT/src/account.js" "$ROOT/src/chrome.jsx" "$ROOT/src/casino.jsx" > "$TMP/app.tsx"
  ...
  local NAMEERR
  cat "$ROOT/src/engine.js" "$ROOT/src/holdem.js" "$ROOT/src/account.js" "$ROOT/src/chrome.jsx" "$ROOT/src/casino.jsx" "$ROOT/$SRC" > "$TMP/guard.tsx"
...
for f in index.html trainer.html play.html table.html profile.html roulette.html craps.html; do

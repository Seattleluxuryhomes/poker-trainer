 ...
 * WebView. Navigation between the landing page, trainer, game, and table (all local
 * .html files) stays inside the WebView; external links (the GitHub repo in About)
 * are handed to the device's browser via an Intent — the app itself never touches
 * the network, so this works while staying fully offline / INTERNET-permission-free.
 */
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        settings.setDomStorageEnabled(true);   // practice stats + bankroll live in localStorage
